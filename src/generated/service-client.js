...
var ServiceClient = /** @class */ (function () {
     ...
     * @return Success
     */
    ServiceClient.prototype.getAddressesByUser = function (userId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Address/GetAddressesByUser?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetAddressesByUser(response_);
    ...
    ServiceClient.prototype.processGetAddressesByUser = function (response) {
        var e_1, _a;
        var _this = this;
     ...
     * @return Success
     */
    ServiceClient.prototype.getDtpOrderDetail = function (orderId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/DtpOrder/GetDtpOrderDetail?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetDtpOrderDetail(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetDtpOrderDetail(response_);
    ...
    ServiceClient.prototype.processGetDtpOrderDetail = function (response) {
        var e_26, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getHandCarryDisbursementsByHcp = function (hcpId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Hcp/GetHandCarryDisbursementsByHcp?";
        if (hcpId !== undefined && hcpId !== null)
            url_ += "HcpId=" + encodeURIComponent("" + hcpId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetHandCarryDisbursementsByHcp(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetHandCarryDisbursementsByHcp(response_);
    ...
    ServiceClient.prototype.processGetHandCarryDisbursementsByHcp = function (response) {
        var e_35, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getHandCarrySignatureAuditsByHcp = function (hcpId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Hcp/GetHandCarrySignatureAuditsByHcp?";
        if (hcpId !== undefined && hcpId !== null)
            url_ += "HcpId=" + encodeURIComponent("" + hcpId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetHandCarrySignatureAuditsByHcp(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetHandCarrySignatureAuditsByHcp(response_);
    ...
    ServiceClient.prototype.processGetHandCarrySignatureAuditsByHcp = function (response) {
        var e_37, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getHandCarryTransactionsByRep = function (repId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Rep/GetHandCarryTransactionsByRep?";
        if (repId !== undefined && repId !== null)
            url_ += "RepId=" + encodeURIComponent("" + repId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetHandCarryTransactionsByRep(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetHandCarryTransactionsByRep(response_);
    ...
    ServiceClient.prototype.processGetHandCarryTransactionsByRep = function (response) {
        var e_55, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getHandCarryInventoriesByRep = function (repId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Rep/GetHandCarryInventoriesByRep?";
        if (repId !== undefined && repId !== null)
            url_ += "RepId=" + encodeURIComponent("" + repId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetHandCarryInventoriesByRep(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetHandCarryInventoriesByRep(response_);
    ...
    ServiceClient.prototype.processGetHandCarryInventoriesByRep = function (response) {
        var e_57, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getHandCarrySignatureAuditsByRep = function (repId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Rep/GetHandCarrySignatureAuditsByRep?";
        if (repId !== undefined && repId !== null)
            url_ += "RepId=" + encodeURIComponent("" + repId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetHandCarrySignatureAuditsByRep(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetHandCarrySignatureAuditsByRep(response_);
    ...
    ServiceClient.prototype.processGetHandCarrySignatureAuditsByRep = function (response) {
        var e_59, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getHandCarryReconciliationsByRep = function (repId) {
        var _this = this;
        var url_ = this.baseUrl + "/api/Rep/GetHandCarryReconciliationsByRep?";
        if (repId !== undefined && repId !== null)
            url_ += "RepId=" + encodeURIComponent("" + repId) + "&";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetHandCarryReconciliationsByRep(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetHandCarryReconciliationsByRep(response_);
    ...
    ServiceClient.prototype.processGetHandCarryReconciliationsByRep = function (response) {
        var e_61, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getInventoryShippedByItemReportData = function () {
        var _this = this;
        var url_ = this.baseUrl + "/api/Report/GetInventoryShippedByItemReportData";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            observe: "response",
            responseType: "blob",
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetInventoryShippedByItemReportData(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetInventoryShippedByItemReportData(response_);
    ...
    ServiceClient.prototype.processGetInventoryShippedByItemReportData = function (response) {
        var e_67, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
     ...
     * @return Success
     */
    ServiceClient.prototype.getPendingAocs = function () {
        var _this = this;
        var url_ = this.baseUrl + "/api/Report/GetPendingAocs";
        url_ = url_.replace(/[?&]$/, "");
        var options_ = {
            observe: "response",
            responseType: "blob",
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap(function (response_) {
            return _this.processGetPendingAocs(response_);
        })).pipe(_observableCatch(function (response_) {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return _this.processGetPendingAocs(response_);
    ...
    ServiceClient.prototype.processGetPendingAocs = function (response) {
        var e_69, _a;
        var _this = this;
        var status = response.status;
        var responseBlob = response instanceof HttpResponse ? response.body :
        ...
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap(function (_responseText) {
                ...
                if (Array.isArray(resultData200)) {
                    result200 = [];
                    try {
                        for (var resultData200_32 = __values(resultData200), resultData200_32_1 = resultData200_32.next(); !resultData200_32_1.done; resultData200_32_1 = resultData200_32.next()) {
                            var item = resultData200_32_1.value;
                        ...
                        try {
                            if (resultData200_32_1 && !resultData200_32_1.done && (_a = resultData200_32.return)) _a.call(resultData200_32);
                        }
...
var DtpOrderDto = /** @class */ (function () {
    function DtpOrderDto(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    DtpOrderDto.prototype.init = function (_data) {
        var e_82, _a;
        if (_data) {
            this.id = _data["id"];
    ...
    DtpOrderDto.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new DtpOrderDto();
        result.init(data);
        return result;
    };
    DtpOrderDto.prototype.toJSON = function (data) {
        var e_83, _a;
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
    ...
    DtpOrderDto.prototype.clone = function () {
        var json = this.toJSON();
        var result = new DtpOrderDto();
        result.init(json);
        return result;
...
var Product = /** @class */ (function () {
    ...
    Product.prototype.toJSON = function (data) {
        var e_92, _a, e_93, _b, e_94, _c, e_95, _d;
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["tenantId"] = this.tenantId;
        data["code"] = this.code;
...
var Hcp = /** @class */ (function () {
    ...
    Hcp.prototype.init = function (_data) {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["dtrOrders"])) {
                this.dtrOrders = [];
                try {
                    for (var _c = __values(_data["dtrOrders"]), _d = _c.next(); !_d.done; _d = _c.next()) {
                        var item = _d.value;
                        this.dtrOrders.push(DtrOrder.fromJS(item));
                    }
                }
            ...
            if (Array.isArray(_data["dtpOrders"])) {
                this.dtpOrders = [];
                try {
                    for (var _e = __values(_data["dtpOrders"]), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var item = _f.value;
                        this.dtpOrders.push(DtpOrder.fromJS(item));
                    }
                }
    ...
    Hcp.prototype.toJSON = function (data) {
        ...
        if (Array.isArray(this.dtrOrders)) {
            data["dtrOrders"] = [];
            try {
                for (var _c = __values(this.dtrOrders), _d = _c.next(); !_d.done; _d = _c.next()) {
                    var item = _d.value;
                    data["dtrOrders"].push(item.toJSON());
                }
            }
        ...
        if (Array.isArray(this.dtpOrders)) {
            data["dtpOrders"] = [];
            try {
                for (var _e = __values(this.dtpOrders), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var item = _f.value;
                    data["dtpOrders"].push(item.toJSON());
                }
            }
...
var Rep = /** @class */ (function () {
    ...
    Rep.prototype.init = function (_data) {
        var e_104, _a, e_105, _b, e_106, _c, e_107, _d;
        if (_data) {
            this.id = _data["id"];
            this.firstName = _data["firstName"];
            this.middleName = _data["middleName"];
            ...
            if (Array.isArray(_data["repPushShipments"])) {
                ...
                try {
                    for (var _e = __values(_data["repPushShipments"]), _f = _e.next(); !_f.done; _f = _e.next()) {
                        var item = _f.value;
            ...
            if (Array.isArray(_data["dtrOrders"])) {
                this.dtrOrders = [];
                try {
                    for (var _g = __values(_data["dtrOrders"]), _h = _g.next(); !_h.done; _h = _g.next()) {
                        var item = _h.value;
                        this.dtrOrders.push(DtrOrder.fromJS(item));
                    }
                }
            ...
            if (Array.isArray(_data["repTerritories"])) {
                this.repTerritories = [];
                try {
                    for (var _l = __values(_data["repTerritories"]), _m = _l.next(); !_m.done; _m = _l.next()) {
                        var item = _m.value;
    ...
    Rep.prototype.toJSON = function (data) {
        ...
        if (Array.isArray(this.repPushShipments)) {
            ...
            try {
                for (var _e = __values(this.repPushShipments), _f = _e.next(); !_f.done; _f = _e.next()) {
                    var item = _f.value;
        ...
        if (Array.isArray(this.dtrOrders)) {
            data["dtrOrders"] = [];
            try {
                for (var _g = __values(this.dtrOrders), _h = _g.next(); !_h.done; _h = _g.next()) {
                    var item = _h.value;
                    data["dtrOrders"].push(item.toJSON());
                }
            }
        ...
        if (Array.isArray(this.repTerritories)) {
            data["repTerritories"] = [];
            try {
                for (var _l = __values(this.repTerritories), _m = _l.next(); !_m.done; _m = _l.next()) {
                    var item = _m.value;
...
export { Rep };
var HandCarryDisbursement = /** @class */ (function () {
    function HandCarryDisbursement(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    HandCarryDisbursement.prototype.init = function (_data) {
        if (_data) {
            this.id = _data["id"];
            this.tenantId = _data["tenantId"];
            ...
            this.disbursementDate = _data["disbursementDate"] ? new Date(_data["disbursementDate"].toString()) : undefined;
            this.hcpId = _data["hcpId"];
            this.repId = _data["repId"];
            this.territoryId = _data["territoryId"];
            this.status = _data["status"];
            ...
            this.hcp = _data["hcp"] ? Hcp.fromJS(_data["hcp"]) : undefined;
            this.rep = _data["rep"] ? Rep.fromJS(_data["rep"]) : undefined;
            this.territory = _data["territory"] ? Territory.fromJS(_data["territory"]) : undefined;
        }
    };
    HandCarryDisbursement.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new HandCarryDisbursement();
        result.init(data);
        return result;
    };
    HandCarryDisbursement.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["tenantId"] = this.tenantId;
        ...
        data["disbursementDate"] = this.disbursementDate ? this.disbursementDate.toISOString() : undefined;
        data["hcpId"] = this.hcpId;
        data["repId"] = this.repId;
        data["territoryId"] = this.territoryId;
        data["status"] = this.status;
        ...
        data["hcp"] = this.hcp ? this.hcp.toJSON() : undefined;
        data["rep"] = this.rep ? this.rep.toJSON() : undefined;
        data["territory"] = this.territory ? this.territory.toJSON() : undefined;
        return data;
    };
    HandCarryDisbursement.prototype.clone = function () {
        var json = this.toJSON();
        var result = new HandCarryDisbursement();
        result.init(json);
        return result;
    };
    return HandCarryDisbursement;
}());
export { HandCarryDisbursement };
var HandCarrySignatureAudit = /** @class */ (function () {
    function HandCarrySignatureAudit(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    HandCarrySignatureAudit.prototype.init = function (_data) {
        if (_data) {
            this.id = _data["id"];
            this.tenantId = _data["tenantId"];
    ...
    HandCarrySignatureAudit.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new HandCarrySignatureAudit();
        result.init(data);
        return result;
    };
    HandCarrySignatureAudit.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["tenantId"] = this.tenantId;
        data["year"] = this.year;
    ...
    HandCarrySignatureAudit.prototype.clone = function () {
        var json = this.toJSON();
        var result = new HandCarrySignatureAudit();
        result.init(json);
        return result;
    };
    return HandCarrySignatureAudit;
}());
export { HandCarrySignatureAudit };
...
var HandCarryTransactionSummaryDto = /** @class */ (function () {
    function HandCarryTransactionSummaryDto(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    HandCarryTransactionSummaryDto.prototype.init = function (_data) {
        if (_data) {
            this.id = _data["id"];
            ...
            this.referenceNumber = _data["referenceNumber"];
            this.transactionDate = _data["transactionDate"] ? new Date(_data["transactionDate"].toString()) : undefined;
            this.repId = _data["repId"];
            this.status = _data["status"];
            this.validForRecon = _data["validForRecon"];
            this.paperReferenceNumber = _data["paperReferenceNumber"];
    ...
    HandCarryTransactionSummaryDto.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new HandCarryTransactionSummaryDto();
        result.init(data);
        return result;
    };
    HandCarryTransactionSummaryDto.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
    ...
    HandCarryTransactionSummaryDto.prototype.clone = function () {
        var json = this.toJSON();
        var result = new HandCarryTransactionSummaryDto();
        result.init(json);
        return result;
    };
    return HandCarryTransactionSummaryDto;
}());
export { HandCarryTransactionSummaryDto };
var HandCarryInventory = /** @class */ (function () {
    function HandCarryInventory(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    HandCarryInventory.prototype.init = function (_data) {
        if (_data) {
            this.id = _data["id"];
            this.tenantId = _data["tenantId"];
            this.reportedDate = _data["reportedDate"] ? new Date(_data["reportedDate"].toString()) : undefined;
            this.productId = _data["productId"];
            this.lotNumber = _data["lotNumber"];
            this.lotExpiryDate = _data["lotExpiryDate"] ? new Date(_data["lotExpiryDate"].toString()) : undefined;
            this.repId = _data["repId"];
            this.territoryId = _data["territoryId"];
    ...
    HandCarryInventory.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new HandCarryInventory();
        result.init(data);
        return result;
    };
    HandCarryInventory.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["tenantId"] = this.tenantId;
        data["reportedDate"] = this.reportedDate ? this.reportedDate.toISOString() : undefined;
        data["productId"] = this.productId;
        data["lotNumber"] = this.lotNumber;
        data["lotExpiryDate"] = this.lotExpiryDate ? this.lotExpiryDate.toISOString() : undefined;
        data["repId"] = this.repId;
        data["territoryId"] = this.territoryId;
    ...
    HandCarryInventory.prototype.clone = function () {
        var json = this.toJSON();
        var result = new HandCarryInventory();
        result.init(json);
        return result;
    };
    return HandCarryInventory;
}());
export { HandCarryInventory };
var HandCarryReconciliation = /** @class */ (function () {
    function HandCarryReconciliation(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    HandCarryReconciliation.prototype.init = function (_data) {
        if (_data) {
            this.id = _data["id"];
            this.tenantId = _data["tenantId"];
            this.inventoryStartDate = _data["inventoryStartDate"] ? new Date(_data["inventoryStartDate"].toString()) : undefined;
            this.inventoryEndDate = _data["inventoryEndDate"] ? new Date(_data["inventoryEndDate"].toString()) : undefined;
    ...
    HandCarryReconciliation.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new HandCarryReconciliation();
        result.init(data);
        return result;
    };
    HandCarryReconciliation.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["tenantId"] = this.tenantId;
        data["inventoryStartDate"] = this.inventoryStartDate ? this.inventoryStartDate.toISOString() : undefined;
        data["inventoryEndDate"] = this.inventoryEndDate ? this.inventoryEndDate.toISOString() : undefined;
    ...
    HandCarryReconciliation.prototype.clone = function () {
        var json = this.toJSON();
        var result = new HandCarryReconciliation();
        result.init(json);
        return result;
    };
    return HandCarryReconciliation;
}());
export { HandCarryReconciliation };
...
export { Report };
var InventoryShippedByItemReportDto = /** @class */ (function () {
    function InventoryShippedByItemReportDto(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    InventoryShippedByItemReportDto.prototype.init = function (_data) {
        if (_data) {
            this.jobId = _data["jobId"];
            this.productCode = _data["productCode"];
            this.productName = _data["productName"];
    ...
    InventoryShippedByItemReportDto.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new InventoryShippedByItemReportDto();
        result.init(data);
        return result;
    };
    InventoryShippedByItemReportDto.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["jobId"] = this.jobId;
        data["productCode"] = this.productCode;
        data["productName"] = this.productName;
    ...
    InventoryShippedByItemReportDto.prototype.clone = function () {
        var json = this.toJSON();
        var result = new InventoryShippedByItemReportDto();
        result.init(json);
        return result;
    };
    return InventoryShippedByItemReportDto;
}());
export { InventoryShippedByItemReportDto };
var AocReportDto = /** @class */ (function () {
    function AocReportDto(data) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    this[property] = data[property];
    ...
    AocReportDto.prototype.init = function (_data) {
        if (_data) {
            this.repId = _data["repId"];
            this.repFirstName = _data["repFirstName"];
            this.repLastName = _data["repLastName"];
            ...
            this.aocFollowUpLetter1 = _data["aocFollowUpLetter1"] ? new Date(_data["aocFollowUpLetter1"].toString()) : undefined;
            this.aocFollowUpLetter2 = _data["aocFollowUpLetter2"] ? new Date(_data["aocFollowUpLetter2"].toString()) : undefined;
            this.aocFollowUpLetter3 = _data["aocFollowUpLetter3"] ? new Date(_data["aocFollowUpLetter3"].toString()) : undefined;
        }
    };
    AocReportDto.fromJS = function (data) {
        data = typeof data === 'object' ? data : {};
        var result = new AocReportDto();
        result.init(data);
        return result;
    };
    AocReportDto.prototype.toJSON = function (data) {
        data = typeof data === 'object' ? data : {};
        data["repId"] = this.repId;
        data["repFirstName"] = this.repFirstName;
        data["repLastName"] = this.repLastName;
        ...
        data["aocFollowUpLetter1"] = this.aocFollowUpLetter1 ? this.aocFollowUpLetter1.toISOString() : undefined;
        data["aocFollowUpLetter2"] = this.aocFollowUpLetter2 ? this.aocFollowUpLetter2.toISOString() : undefined;
        data["aocFollowUpLetter3"] = this.aocFollowUpLetter3 ? this.aocFollowUpLetter3.toISOString() : undefined;
        return data;
    };
    AocReportDto.prototype.clone = function () {
        var json = this.toJSON();
        var result = new AocReportDto();
        result.init(json);
        return result;
